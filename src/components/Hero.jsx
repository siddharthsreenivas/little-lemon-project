          ...
          <div className="flex flex-col md:flex-row  gap-6 py-10 items-center relative">
            <div className="flex flex-col justify-center items-center md:items-start gap-4">
                <div className="-space-y-3">
                  <h1 className="text-theme-yellow font-Markazi text-6xl font-medium" aria-label="Little Lemon">Little Lemon</h1>
                ...
                <button className="py-3 px-9 rounded-2xl text-xl font-semibold font-Karla bg-theme-yellow text-theme-green w-fit hover:scale-[102%] transition-all duration-200 hover:shadow-md hover:shadow-theme-gray/20 active:scale-[98%]"aria-label="Reserve a table button">Reserve a Table</button>
                </Link>
            </div>
